# -*- coding: utf-8 -*-
"""
Example 2: Judge a coding candidate's workspace with Codex as the agent.

Dependencies: Codex CLI installed (`npm install -g @openai/codex`).
Environment: OPENAI_API_KEY (inherited by the harness's subprocess from this
    process's environment), or a prior `codex login`.
"""
import asyncio
import tempfile
...
from openjudge.harness import CodexHarness
...
async def main() -> None:
    harness = CodexHarness(timeout_s=120)
