# -*- coding: utf-8 -*-
"""
Example 3: Judge a coding candidate's workspace with the Cursor CLI agent.

Dependencies: Cursor CLI installed (see https://cursor.com/cli).
Environment: CURSOR_API_KEY (inherited by the harness's subprocess from this
    process's environment), or a prior interactive `cursor-agent` login.
"""
import asyncio
import tempfile
...
from openjudge.harness import CursorAgentHarness
...
async def main() -> None:
    harness = CursorAgentHarness(timeout_s=120)
