# Pairwise Training Script for Qwen3 using HelpSteer3 Dataset
# Adapted for general pairwise comparison training tasks
...
PROJECT_NAME=helpsteer3_pairwise_qwen3_8b
EXPERIMENT_NAME=rm-gallery-qwen3-pairwise-${TIMESTAMP}
...
CUSTOM_CHAT_RL_DATASET_NAME=PairwiseComparisonDataset
REWARD_MANAGER=naive
REWARD_FUNCTION_NAME=compute_score


DEFAULT_LOCAL_DIR=./checkpoints/pairwise/${TIMESTAMP}
...
ray job submit --address="http://127.0.0.1:8265" \
    --runtime-env=./rm_gallery/gallery/train/pairwise/runtime_env.yaml \
    -- \
    ...
    data.pairwise_response_index=0 \
