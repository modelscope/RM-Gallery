...
from rm_gallery.gallery.rmb.helpfulness import TASKS
from rm_gallery.gallery.rmb.helpfulness.base import HelpfulnessListWiseReward
...
def test_evaluate(
    file: str = "data/RMBbench/pairwise/Helpfulness/Role Playing/Specific Character.jsonl",
    principles: List[str] = ["The answer must follow the query."],
    scenario: str = SCENARIO,
):
    ...
    reward_module = HelpfulnessListWiseReward(
        llm=llm,
...
def test_all(tasks):
    ...
    write_json(results, "data/RMBbench/results_10_1.json")
